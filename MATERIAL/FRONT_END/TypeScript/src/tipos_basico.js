...
let height = 1.95;
age = 28;
const nation = "japanese";
const person = ["macaco", "preto", "prego"];
const tech = ["solidity", "keras", "tensorflow"];
const notes = [10000, 234234, 34253425, 2342342];
// ------------------------------- TUPLAS --------------------------------------
const list = [
    "macaco",
    234234,
...
let curso = "front-end";
// curso = 42;
//# sourceMappingURL=tipos_basico.js.map